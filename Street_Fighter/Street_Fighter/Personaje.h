...
void Personaje::actualizar(float tiempo) {
	...
	}else if (Keyboard::isKeyPressed(Keyboard::D) && (pos_x + 750 * tiempo) < ANCHO_PANTALLA){
	...
	animacion.actualizar(fila,sprite,numSprites[fila][sprite], tiempo);
